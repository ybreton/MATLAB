...
set(eh,'color','b')
hold on
ph(1)=plot(nanmean(mpRegret(idVeh,:),1),'bo','markerfacecolor','w');
eh=errorbar(nanmean(mpRegret(idCNO,:),1),nanstderr(mpRegret(idCNO,:)));
ph(2)=plot(nanmean(mpRegret(idCNO,:),1),'ro','markerfacecolor','w');
set(eh,'color','r')
hold off
xtick = [sd.landmarks.ZoneEntry.LinPos;sd.landmarks.ChoicePoint.LinPos;sd.landmarks.Feeder.LinPos;sd.landmarks.ArmExit.LinPos];
xtick = xtick(:);
set(gca,'xtick',xtick)
xticklabel={'Z' 'CP' 'F' 'X' 'Z+1' 'CP+1' 'F+1' 'X+1' 'Z+2' 'CP+2' 'F+2' 'X+2' 'Z-1' 'CP-1' 'F-1' 'X-1'};
set(gca,'xticklabel',xticklabel)
legend(ph,{'Saline' 'CNO'})
%%
mpRejoice = squeeze(nanmean(pRejoice,2));
eh=errorbar(nanmean(mpRejoice(idVeh,:),1),nanstderr(mpRejoice(idVeh,:)));
set(eh,'color','b')
hold on
ph(1)=plot(nanmean(mpRejoice(idVeh,:),1),'bo','markerfacecolor','w');
eh=errorbar(nanmean(mpRejoice(idCNO,:),1),nanstderr(mpRejoice(idCNO,:)));
ph(2)=plot(nanmean(mpRejoice(idCNO,:),1),'ro','markerfacecolor','w');
set(eh,'color','r')
hold off
xtick = [sd.landmarks.ZoneEntry.LinPos;sd.landmarks.ChoicePoint.LinPos;sd.landmarks.Feeder.LinPos;sd.landmarks.ArmExit.LinPos];
xtick = xtick(:);
...
legend(ph,{'Saline' 'CNO'})
%%
mpDisapp = squeeze(nanmean(pDisapp1,2));
eh=errorbar(nanmean(mpDisapp(idVeh,:),1),nanstderr(mpDisapp(idVeh,:)));
set(eh,'color','b')
hold on
ph(1)=plot(nanmean(mpDisapp(idVeh,:),1),'bo','markerfacecolor','w');
eh=errorbar(nanmean(mpDisapp(idCNO,:),1),nanstderr(mpDisapp(idCNO,:)));
ph(2)=plot(nanmean(mpDisapp(idCNO,:),1),'ro','markerfacecolor','w');
set(eh,'color','r')
hold off
xtick = [sd.landmarks.ZoneEntry.LinPos;sd.landmarks.ChoicePoint.LinPos;sd.landmarks.Feeder.LinPos;sd.landmarks.ArmExit.LinPos];
xtick = xtick(:);
...
legend(ph,{'Saline' 'CNO'})
%%
mpDisapp = squeeze(nanmean(pDisapp2,2));
eh=errorbar(nanmean(mpDisapp(idVeh,:),1),nanstderr(mpDisapp(idVeh,:)));
set(eh,'color','b')
hold on
ph(1)=plot(nanmean(mpDisapp(idVeh,:),1),'bo','markerfacecolor','w');
...
legend(ph,{'Saline' 'CNO'})
%%
mpAll = squeeze(nanmean(pAll,2));
eh=errorbar(nanmean(mpAll(idVeh,:),1),nanstderr(mpAll(idVeh,:)));
set(eh,'color','b')
hold on
ph(1)=plot(nanmean(mpAll(idVeh,:),1),'bo','markerfacecolor','w');
eh=errorbar(nanmean(mpAll(idCNO,:),1),nanstderr(mpAll(idCNO,:)));
ph(2)=plot(nanmean(mpAll(idCNO,:),1),'ro','markerfacecolor','w');
set(eh,'color','r')
hold off
xtick = [sd.landmarks.ZoneEntry.LinPos;sd.landmarks.ChoicePoint.LinPos;sd.landmarks.Feeder.LinPos;sd.landmarks.ArmExit.LinPos];
xtick = xtick(:);
