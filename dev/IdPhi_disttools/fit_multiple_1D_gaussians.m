function [bestfit,fitlist] = fit_multiple_1D_gaussians(x,c,varargin)
%
%
%
%
...
while K<maxK & ~converge
    ...
    [fit(K).fit,LnL] = fit_1D_EM_gaussian_mixture(x,c,K,'MinDiff',MinDiff);
    ...
    if plotFlag
        ...
        cla
        ah = hist_gauss_overlay(x(~c),fit(K).fit);
        drawnow
    end
end
