function BuildDatabaseC8midonHT(RawData,setmouse,setday,setpreweight,setpostweight,a,d)
...
xhead=tsd(RawData{animal,day}(:,1),RawData{animal,day}(:,4));
yhead=tsd(RawData{animal,day}(:,1),RawData{animal,day}(:,5));

xtail=tsd(RawData{animal,day}(:,1),RawData{animal,day}(:,6));
ytail=tsd(RawData{animal,day}(:,1),RawData{animal,day}(:,7));
...
taskEvents.EnterTimeStampLog (RawData{animal,day}(:,17)==0 & RawData{animal,day}(:,22)==0 & RawData{animal,day}(:,27)==0 & RawData{animal,day}(:,32)==0) = NaN;
...
taskEvents.SkipTimeStampLog (RawData{animal,day}(:,16)==0 & RawData{animal,day}(:,21)==0 & RawData{animal,day}(:,26)==0 & RawData{animal,day}(:,31)==0) = NaN;
...
taskEvents.QuitTimeStampLog (RawData{animal,day}(:,18)==0 & RawData{animal,day}(:,23)==0 & RawData{animal,day}(:,28)==0 & RawData{animal,day}(:,33)==0) = NaN;
...
taskEvents.EarnTimeStampLog (RawData{animal,day}(:,19)==0 & RawData{animal,day}(:,24)==0 & RawData{animal,day}(:,29)==0 & RawData{animal,day}(:,34)==0) = NaN;
...
save(['C:\Users\TLWS-11\Documents\MATLAB\BrianDatabase\',taskEvents.SSN(1:4),'\',taskEvents.SSN,'\',taskEvents.SSN,'-vt.mat'],'x','y','xhead','yhead','xtail','ytail');
