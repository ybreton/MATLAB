...
if RatTrackParms.getOrientation
    ...
    RatTrackData.Hx(RatTrackData.currentFrameCount) = LEDx+25*cos(LEDphiH);
    RatTrackData.Hy(RatTrackData.currentFrameCount) = LEDy+25*sin(LEDphiH);
else
    RatTrackData.LEDphiB(RatTrackData.currentFrameCount) = nan;
    RatTrackData.LEDphiH(RatTrackData.currentFrameCount) = nan;
    RatTrackData.Hx(RatTrackData.currentFrameCount) = nan;
    RatTrackData.Hy(RatTrackData.currentFrameCount) = nan;
end
