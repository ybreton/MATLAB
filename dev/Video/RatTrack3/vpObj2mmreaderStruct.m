function mmStruct = vpObj2mmreaderStruct(vidObj)
...
mmStruct.filename = vidObj.VideoName;
...
mmStruct.nrFramesTotal = vidObj.NumFrames;
mmStruct.rate = vidObj.NumFrames/vidObj.TotalTime;
mmStruct.totalDuration = vidObj.TotalTime;
