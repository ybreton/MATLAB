function data = RatTrackPrepareFrameFromVideo(data, width, height, frameNr, time)
% frame = RatTrackPrepareFrameFromVideo(data, width, height, frameNr, time)
% taken from ProcessVideo (mmread)
